...
AlloyGBM/
  ...
  docs/
    limitations.md         # Current limitation analysis (last updated for v0.12.4; refactor program completed in v0.12.3; CPU-only + PL-leaf SHAP interactions still pending)
