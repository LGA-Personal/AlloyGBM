use crate::errors::{predictor_error_to_pyerr, shap_error_to_pyerr};
...
use crate::{MAX_CONTINUOUS_QUANTIZED_BIN_U8, dense_rows_from_flat_values};
...
// -- Piece C: predictor + shap #[pyfunction] wrappers ------------------------
