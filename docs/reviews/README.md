...
| [Single-thread throughput](2026-09-06-single-thread-throughput.md) — accuracy and scaling are at parity; per-core speed is the remaining 1.4x-5.3x gap | v1.0.0-prep | Claude Opus 5 | [Open](../ideas/single-thread-optimization-board.md) |
