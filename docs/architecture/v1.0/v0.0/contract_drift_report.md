# v0.0 Contract Drift Report

## Scope
- Layer: `docs/architecture/v1.0/v0.0`
- Plan reference: `docs/architecture/v1.0/v0.0/plan.md`
- Ancestor reference: `docs/architecture/v1.0/plan.md`
- Check date (UTC): 2026-02-25

## Planned Contract Baseline (v0.0)
...
- Observed:
  - plans/roadmap use `bindings_python` naming (`docs/architecture/v1.0/plan.md`, `docs/architecture/v1.0/v0.0/plan.md`, `docs/architecture/gpu_financial_gbm_roadmap.md`).
...
- Evidence:
  ...
  - `GBMRegressor` constructor and parameter validation are callable (`bindings/python/alloygbm/regressor.py`), aligned with `v0.0` acceptance intent.
...
## Conclusion
- `v0.0` implementation remains aligned with planned contract boundaries and dependency direction.
