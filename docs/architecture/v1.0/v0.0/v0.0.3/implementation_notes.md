...
- Kept the engine scope at single-round orchestration (`fit_one_round`) rather than introducing multi-tree loops. This preserves `v0.0` contracts-first intent and avoids crossing into full `0.1.0` algorithm scope.
