...
## Scope
- Layer: `docs/architecture/v1.0/v0.0/v0.0.2`
- Plan: `docs/architecture/v1.0/v0.0/v0.0.2/plan.md`
...
- `v0.0.3` under `docs/architecture/v1.0/v0.0/` to begin minimal training/inference behavior implementation on top of stabilized contracts.
