# AlloyGBM v0.0.11 Plan (v0.0 Week 11 CI Closeout and Python Contract Smoke)

## Objective
Close the remaining `v0.0` acceptance gaps by hardening CI evidence for Rust docs/build checks and installed-wheel Python contract behavior.
