# AlloyGBM v0.0.6 Plan (v0.0 Week 6 Leaf Policy Controls + Artifact Compatibility)
...
- Out of scope:
  ...
  - Predictor crate integration or public compatibility guarantees outside internal `v0.0` artifacts.
