...
- Audience: engineers preparing `v0.9.3` performance optimization and `v0.9.4` release-policy closeout.
...
- CI hard-fail benchmark threshold enforcement finalization intended for `v0.9.4` (policy draft updates allowed, full enforcement deferred).
