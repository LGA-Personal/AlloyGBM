...
## Scope
- Layer: `docs/architecture/v1.0/v0.1/v0.0.3`
- Plan: `docs/architecture/v1.0/v0.1/v0.0.3/plan.md`
...
- `v0.0.4` under `docs/architecture/v1.0/v0.1/` for iterative tree-growth loop and initial end-to-end model artifact plumbing.
