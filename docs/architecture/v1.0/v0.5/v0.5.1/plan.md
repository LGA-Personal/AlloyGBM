# AlloyGBM v0.5.1 Plan (v0.5 Compatibility Policy Baseline Slice)

## Summary
- Goal: execute the first `v0.5` child slice by locking model-format v1 compatibility policy and adding baseline IO contract tests for predictor ingestion behavior.
- Success criteria:
...
- Audience: engineers implementing `v0.5` compatibility hardening and reviewers validating readiness for deeper predictor-path canonicalization in `v0.5.2+`.
...
- Layer artifacts:
  - `docs/architecture/v1.0/v0.5/v0.5.1/implementation_notes.md`
  - `docs/architecture/v1.0/v0.5/v0.5.1/verification_report.md`
...
5. `docs/architecture/v1.0/v0.5/v0.5.1/implementation_notes.md` is created with implementation rationale and deferred gaps.
6. `docs/architecture/v1.0/v0.5/v0.5.1/verification_report.md` is created with criterion-to-evidence mapping.
