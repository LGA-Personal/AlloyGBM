# AlloyGBM v0.8.4 Plan (v0.8 Migration and Compatibility Narrative Slice)

## Summary
- Goal: execute `v0.8.4` by finalizing the migration/compatibility narrative and producing command-backed compatibility evidence required to close `v0.8` parent rollup.
- Success criteria:
  ...
  - layer state advances from child `v0.8.4` to parent `docs/architecture/v1.0/v0.8` closeout target.
- Audience: engineers and reviewers preparing `0.8.0` release-candidate hardening sign-off and `1.0.0` go/no-go review.

## Scope
### In Scope
- Create `v0.8.4` layer artifacts:
  - `docs/architecture/v1.0/v0.8/v0.8.4/plan.md`
  - `docs/architecture/v1.0/v0.8/v0.8.4/implementation_notes.md`
  - `docs/architecture/v1.0/v0.8/v0.8.4/verification_report.md`
- Author migration/compatibility narrative artifact:
  - `docs/architecture/v1.0/v0.8/v0.8.4/migration_compatibility_narrative.md`
- Update hardening baseline traceability:
  - refresh `docs/architecture/v1.0/v0.8/v0.8.1/release_hardening_matrix.md` with `v0.8.4` bucket closure status and artifact links.
...
- Update `docs/architecture/state/layer_index.yaml`:
  - mark `docs/architecture/v1.0/v0.8/v0.8.4` as `verified`,
  - advance `active_target` and `suggested_next_layer` to `docs/architecture/v1.0/v0.8` for parent rollup closeout.

### Out of Scope
- Authoring parent `v0.8` rollup artifacts (`docs/architecture/v1.0/v0.8/implementation_notes.md`, `verification_report.md`).
...
- Documentation/state interfaces in scope:
  - `docs/architecture/v1.0/v0.8/v0.8.4/migration_compatibility_narrative.md`
  - `docs/architecture/v1.0/v0.8/v0.8.1/release_hardening_matrix.md`
...
- strict and legacy-compatible behavior remains as established in `v0.6.x` and carried through `v0.7.x`.
...
6. Update `layer_index.yaml` to set next target to parent `docs/architecture/v1.0/v0.8`.
...
## Acceptance Criteria
1. `docs/architecture/v1.0/v0.8/v0.8.4/plan.md` is present and decision-complete.
2. `docs/architecture/v1.0/v0.8/v0.8.4/migration_compatibility_narrative.md` exists and includes migration impact, compatibility policy, and operator checklist.
3. `docs/architecture/v1.0/v0.8/v0.8.1/release_hardening_matrix.md` is updated to record migration/compatibility bucket closure in `v0.8.4`.
4. `docs/architecture/v1.0/v0.8/v0.8.4/implementation_notes.md` is present.
5. `docs/architecture/v1.0/v0.8/v0.8.4/verification_report.md` is present with criterion-to-evidence mapping.
...
12. `docs/architecture/state/layer_index.yaml` marks `v0.8.4` verified and advances `active_target`/`suggested_next_layer` to `docs/architecture/v1.0/v0.8`.
...
- Parent `v0.8` rollup is the immediate next target after this slice.
