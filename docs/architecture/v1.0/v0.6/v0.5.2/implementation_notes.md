...
- Parent `v0.6` serialization hardening and migration/documentation tightening remain for `v0.5.3`.
...
## Follow-Up Actions
- Create `docs/architecture/v1.0/v0.6/v0.5.3/plan.md` for serialization-contract hardening and failure-mode consistency.
