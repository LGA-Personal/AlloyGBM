# AlloyGBM v0.7.1 Plan (v0.7 SHAP Contract and Additivity Harness Slice)

## Summary
- Goal: execute the first `v0.7` child slice by establishing artifact-backed SHAP interfaces, deterministic validation behavior, and additivity test harnesses before exact TreeSHAP path weighting work.
- Success criteria:
...
- Audience: engineers implementing `v0.7` TreeSHAP work and reviewers gating readiness for `v0.7.2` exact traversal math.
...
- Layer artifacts:
  - `docs/architecture/v1.0/v0.7/v0.7.1/implementation_notes.md`
  - `docs/architecture/v1.0/v0.7/v0.7.1/verification_report.md`
...
1. Add `v0.7.1` plan and lock scope boundaries against parent `v0.7` plan.
...
## Acceptance Criteria
1. `docs/architecture/v1.0/v0.7/v0.7.1/plan.md` is present and decision-complete for this slice.
...
7. `docs/architecture/v1.0/v0.7/v0.7.1/implementation_notes.md` is created.
8. `docs/architecture/v1.0/v0.7/v0.7.1/verification_report.md` is created.
