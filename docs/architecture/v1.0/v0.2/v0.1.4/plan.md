# AlloyGBM v0.1.4 Plan (v0.2 Validation Best-Checkpoint Semantics)

## Objective
Close a remaining `v0.2` training-loop semantics gap by ensuring validation early-stopping returns the best-validation checkpoint model rather than retaining the last plateau-triggering round.
...
- Out of scope:
  ...
  - SIMD/performance work and parent `v0.2` rollup artifacts.
...
2. Verification package:
  ...
  - `docs/architecture/v1.0/v0.2/v0.1.4/implementation_notes.md`
  - `docs/architecture/v1.0/v0.2/v0.1.4/verification_report.md`
3. State package:
