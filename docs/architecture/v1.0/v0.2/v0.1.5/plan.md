# AlloyGBM v0.1.5 Plan (v0.2 Depth-Limited Multi-Node Round Growth)

## Objective
Close a remaining `v0.2` algorithm-depth gap by replacing single-stump-per-round behavior with depth-limited multi-node split growth per boosting round, while preserving deterministic subsampling and validation checkpoint semantics established in `v0.1.2` and `v0.1.4`.
...
2. Verification package:
  ...
  - `docs/architecture/v1.0/v0.2/v0.1.5/implementation_notes.md`
