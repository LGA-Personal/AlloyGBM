# AlloyGBM v0.2.2 Plan (v0.2 Input Adapter Coverage Slice)

## Objective
Execute the next `v0.2` child slice by adding deterministic input normalization adapters so `GBMRegressor` accepts NumPy-like, pandas-like, and Polars-like tabular inputs for `fit`, `predict`, and `predict_from_artifact`, while preserving existing parameter and validation contracts.
...
- Out of scope:
  ...
  - Parent `v0.2` rollup closeout artifacts.
...
3. Layer documentation package:
  - `docs/architecture/v1.0/v0.2/v0.2.2/implementation_notes.md`
  - `docs/architecture/v1.0/v0.2/v0.2.2/verification_report.md`
4. State package:
