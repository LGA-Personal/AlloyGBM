...
## Scope
- Layer: `docs/architecture/v1.0/v0.0/v0.0.4`
- Plan: `docs/architecture/v1.0/v0.0/v0.0.4/plan.md`
...
- `v0.0.5` under `docs/architecture/v1.0/v0.0/` for richer iterative tree growth and broader model artifact coverage.
