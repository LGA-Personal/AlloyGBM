# AlloyGBM v0.0.1 Plan (v0.0 Week 1 Bootstrap)

## Objective
Deliver the first executable slice of `v0.0` by establishing repository structure, crate boundaries, and CI quality gates so all later interface work can land on stable scaffolding.
