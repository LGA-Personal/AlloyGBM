...
use brute_force::{
    decode_tree_node_id, explain_rows_brute_force, tree_local_key, validate_rows, verify_additivity,
};
...
mod tests {
    ...
    use crate::brute_force::{
        compute_subset_expectations, factorial_table, local_path_predict,
